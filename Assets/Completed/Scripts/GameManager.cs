...
namespace Completed
{
	...
	public class GameManager : MonoBehaviour
	{
        ...
        public int playerGoldPoints = 0;                        //Starting value for Player Gold points
		...
		public int level = 1;									//Current level number, expressed in game as "Floor 1".
		...
		public void GameOver()
		{
			...
			levelText.text = "After " + level + " floors, you perished holding " + playerGoldPoints + " gold.";
